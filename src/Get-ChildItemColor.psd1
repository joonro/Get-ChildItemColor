#
# Module manifest for module 'Get-ChildItemColor'
#
# Generated by: Joon Ro
#
...
GUID = '52c0ddeb-6767-42c0-89ad-203df97b22d1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Get-ChildItem', 'ls', 'Color')

        # A URL to the license for this module.
        # LicenseUri = ''

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/joonro/Get-ChildItemColor'
